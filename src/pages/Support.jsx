    ...
    <div className="support-page">
      ...
      <section className="contact-options">
        ...
        <div className="contact-grid">
          <div className="contact-card">
            ...
            <p>
              Nhận hỗ trợ nhanh chóng từ nhóm kỹ thuật viên trong giờ làm việc.
            </p>
          ...
          <div className="contact-card">
            ...
            <h3>Gửi email</h3>
            <p>
              Gửi câu hỏi hoặc yêu cầu hỗ trợ, chúng tôi sẽ phản hồi trong vòng
              24h.
            </p>
      ...
      <section className="faq-section">
        ...
        <div className="faq-list">
          <div className="faq-item">
            ...
            <p>
              Bạn có thể tải phần mềm từ mục "Tải về", sau đó làm theo hướng dẫn
              trong file README hoặc video hướng dẫn đi kèm.
            </p>
          </div>
          <div className="faq-item">
      ...
      <section className="feedback-section">
        ...
        <form className="feedback-form">
          <textarea placeholder="Nhập phản hồi của bạn..." rows={5}></textarea>
